export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'marcaum',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Marcaum',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'marcaum.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://marcaum.com',
